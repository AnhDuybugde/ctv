  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Sâu Tìm Trọ — Tổ ấm xinh ở Đà Nẵng" },
      {
        ...
        content: "Tìm phòng trọ Đà Nẵng nhanh, dễ và ngọt như mật.",
      },
    ],
  }),
  component: HomePage,
...
const popularUniversities = [
  ...
  },
  {
    ...
    count: "450+ phòng trọ",
    image:
      "https://images.unsplash.com/photo-1498243691581-b145c3f54a91?auto=format&fit=crop&w=400&q=80",
  },
  {
    name: "ĐH Ngoại Ngữ",
    count: "600+ phòng trọ",
...
const testimonials = [
  {
    ...
    quote:
      "Nhờ Sâu mà mình tìm được phòng ngay sát trường Bách Khoa chỉ trong 2 ngày. Hình ảnh thực tế giống hệt trên web, không bị treo đầu dê bán thịt chó.",
    initial: "T",
  },
  {
    name: "Cô Mai Hạnh",
    ...
    quote:
      "Lần đầu con đi học xa nhà, tôi rất lo lắng. May nhờ trang web này tìm được ký túc xá an ninh, sạch sẽ. Quy trình làm việc rất chuyên nghiệp.",
    initial: "H",
  },
  {
    name: "Hoàng Long",
    ...
    quote:
      "Giao diện dễ dùng, bộ lọc trường học rất tiện. Mình cực kỳ thích tính năng xem phòng xác thực. Rất recommend cho các bạn tân sinh viên.",
    initial: "L",
  },
];
          ...
          <div className="relative mx-auto max-w-7xl px-4 md:px-6 lg:px-10 w-full z-10">
            <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
              ...
              <div className="lg:col-span-7">
                ...
                >
                  Hỗ trợ tân sinh viên và sinh viên các trường đại học tại Đà
                  Nẵng tìm kiếm nơi ở{" "}
              ...
              <div className="lg:col-span-5 flex flex-col items-center lg:items-end justify-center relative">
                ...
                <div className="w-[180px] md:w-[220px] relative">
                  ...
                  >
                    <div
                      className="h-7 w-7 rounded-lg bg-[#ffc700]/10 flex items-center justify-center text-[#ffc700] shrink-0"
                  ...
                  >
                    ...
                    <div className="text-left leading-none">
                      <span className="text-[10px] font-extrabold text-[#5c4d1a] block">
                        Giá: 2.5Tr/tháng
                      </span>
                      <span className="text-[8px] text-slate-400 font-bold block mt-0.5">
                        Không phát sinh
            ...
            <div className="mt-12">
              ...
              >
                ...
                <div className="sm:col-span-4 px-4 py-2 border-b sm:border-b-0 sm:border-r border-cocoa/10">
                  <label
                    htmlFor="uni-select"
                    className="block text-[10px] font-bold uppercase tracking-widest text-cocoa/50 mb-1"
                  >
                    Trường đại học
                  </label>
                  <select
        ...
        >
          <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-10">
            ...
            <div className="flex flex-wrap items-end justify-between gap-4 mb-12 text-left">
              <div>
                <span className="px-3.5 py-1.5 text-[10px] font-bold uppercase tracking-wider bg-amber-50 text-amber-800 border border-amber-100 rounded-full shadow-sm mb-2.5 inline-block">
                  Gợi ý cho bạn
                </span>
                <h2
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Danh sách những phòng trọ được xác minh kỹ lưỡng, gần các
                  trường đại học với mức giá tốt nhất.
                </p>
              </div>
              <Link
                to="/search"
        ...
        >
          <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-10">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              >
                Tìm kiếm phòng trọ tập trung theo các cụm trường đại học lớn tại
                Đà Nẵng
              </p>
            </div>
              ...
              {popularUniversities.map((uni) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to top, rgba(17,36,25,0.90) 0%, rgba(17,36,25,0.30) 60%, transparent 100%)",
                    }}
                  />
                  {/* Text */}
      ...
      <Link
        ...
        onMouseEnter={(e) => {
          ...
          (e.currentTarget as HTMLAnchorElement).style.boxShadow =
            "0 0 6px rgba(0,0,0,0.30), 0 12px 20px rgba(0,0,0,0.20)";
        }}
        onMouseLeave={(e) => {
          (e.currentTarget as HTMLAnchorElement).style.background =
            "var(--cocoa)";
