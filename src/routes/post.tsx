  ...
  head: () => ({
    meta: [
      { title: "Đăng tin cho thuê — Sâu tìm trọ" },
      {
        name: "description",
        content:
          "Đăng tin phòng cho thuê tại Đà Nẵng — tiếp cận hàng ngàn bạn trẻ đang tìm trọ.",
      },
    ],
  }),
  component: PostPage,
      ...
      <main className="flex-1 mx-auto max-w-4xl w-full px-5 pt-8 pb-12">
        <div className="rounded-3xl bg-gradient-warm p-6 md:p-8 shadow-soft border border-border/60 relative overflow-hidden">
          ...
          <div className="relative max-w-lg">
            <h1 className="font-display text-3xl md:text-4xl font-bold text-cocoa">
              Cho Sâu thuê tổ của bạn
            </h1>
            <p className="mt-1 text-cocoa/75 text-sm">
              Điền vài thông tin — Sâu sẽ giúp tổ của bạn tìm chủ mới chỉ trong
              vài ngày.
            </p>
          </div>
        </div>
        ...
        {done ? (
          <div className="mt-8 rounded-3xl bg-card p-10 text-center border border-border/60 shadow-soft">
            ...
            <h2 className="mt-4 font-display text-2xl font-bold text-cocoa">
              Sâu nhận tin rồi 🎉
            </h2>
          ...
          >
            <Field label="Tiêu đề tin">
              <input
                required
                placeholder="VD: Phòng studio đầy đủ nội thất gần biển Mỹ Khê"
                className={inputCls}
              />
            </Field>
