  ...
  head: () => ({
    meta: [
      { title: "Tìm kiếm phòng trọ quanh trường học Đà Nẵng — Sâu tìm trọ" },
      {
        name: "description",
        content:
          "Lọc phòng trọ theo trường Bách Khoa, FPT, Kinh Tế... giá rẻ, xác thực 100%.",
      },
    ],
  }),
...
const localMockDatabase = {
  bachKhoa: [
    ...
    {
      id: "bk-crawled-2",
      title: "❌❌CHO THUÊ NHÀ 3 TẦNG MT GẦN HÀM NGHI - TRUNG TÂM ĐÀ NẴNG ❌❌",
      price: 1200000,
      area: 130,
      location: "Quận Thanh Khê",
      school: "Cách BK 600m",
      badge: "Xác minh",
      specialBadge: "Mới",
      image: "/crawled_images/chotot-132854974_0.jpg",
      tags: ["Phòng sạch đẹp", "Rộng rãi", "Giá rẻ"],
      isSaved: false,
    },
    {
      id: "bk-crawled-3",
      title: "Tôi chính chủ cần bán nhà trong tháng",
      price: 2590000,
      area: 41,
      ...
      badge: "Xác minh",
      specialBadge: "",
      image: "/crawled_images/chotot-132830759_0.jpg",
      tags: ["Phòng sạch đẹp", "Rộng rãi", "Giá rẻ"],
      isSaved: false,
    },
    {
      id: "bk-crawled-4",
      title: "HOMESTAY 2 MẶT KIỆT PHẠM VĂN NGHỊ - THIỆT KẾ MỚI LẠ",
      price: 5450000,
      area: 57,
      location: "Quận Thanh Khê",
      school: "Cách BK 1.8km",
      badge: "Xác minh",
      specialBadge: "",
      image: "/crawled_images/chotot-132854756_0.jpg",
      tags: ["Phòng sạch đẹp", "Rộng rãi", "Điều hòa"],
      isSaved: false,
    },
  ],
  fpt: [
    {
      ...
      price: 1500000,
      area: 300,
      location: "Quận Ngũ Hành Sơn • Cách FPT 200m",
      badge: "Xác minh",
      areaBadge: "QUẬN NGŨ HÀNH SƠN",
      image: "/crawled_images/chotot-132815165_0.jpg",
      tags: ["300m²", "Phòng sạch đẹp", "Rộng rãi"],
      isSaved: false,
    },
    {
      id: "fpt-crawled-2",
      ...
      price: 3450000,
      area: 41,
      location: "Quận Thanh Khê • Cách FPT 1.8km",
      badge: "Xác minh",
      areaBadge: "QUẬN THANH KHÊ",
      image: "/crawled_images/chotot-132817965_0.jpg",
      tags: ["41m²", "Phòng sạch đẹp", "Rộng rãi"],
      isSaved: false,
    },
    {
      id: "fpt-crawled-3",
      ...
      price: 2500000,
      area: 175,
      location: "Quận Cẩm Lệ • Cách FPT 400m",
      badge: "Xác minh",
      areaBadge: "QUẬN CẨM LỆ",
      image: "/crawled_images/chotot-131438492_0.jpg",
      tags: ["175m²", "Phòng sạch đẹp", "Rộng rãi"],
      isSaved: false,
    },
    {
      id: "fpt-crawled-4",
      ...
      price: 1200000,
      area: 350,
      location: "Quận Hải Châu • Cách FPT 400m",
      badge: "Xác minh",
      areaBadge: "QUẬN HẢI CHÂU",
      image: "/crawled_images/chotot-132751803_0.jpg",
      tags: ["350m²", "Phòng sạch đẹp", "Rộng rãi"],
      isSaved: false,
    },
  ],
};
...
const mockDatabase = {
  bachKhoa: [
    ...localMockDatabase.bachKhoa,
    ...mappedVanMinh.filter((r) => r.uniKey === "bachKhoa"),
  ],
  fpt: [
    ...localMockDatabase.fpt,
    ...mappedVanMinh.filter((r) => r.uniKey === "fpt"),
  ],
  supham: mappedVanMinh.filter((r) => r.uniKey === "supham"),
  duytan: mappedVanMinh.filter((r) => r.uniKey === "duytan"),
};

// Rooms simulated for FPT Detailed Price page to show different rooms and matching images per price level
const fptPriceSimulatorRooms = [
  {
    id: "fpt-sim-01",
    title: "Phòng KTX Tư Nhân Cao Cấp (Bunk Beds)",
    price: 1400000,
    area: 15,
    location: "Hòa Hải, Ngũ Hành Sơn",
    school: "800m từ ĐHFPT",
    badge: "Mới đăng",
    tags: ["1 Giường/Người", "Bao điện nước"],
    priceRange: "Dưới 1.5tr",
    image: roomCard1, // Bunk beds illustration from artifacts
  },
  {
    id: "fpt-sim-02",
    title: "Phòng ghép sinh viên tiết kiệm Hòa Hải",
    price: 1200000,
    area: 16,
    location: "Điện Ngọc, Quảng Nam",
    school: "1.5km từ ĐHFPT",
    badge: "Xác minh",
    tags: ["Ký túc xá", "Bếp chung"],
    priceRange: "Dưới 1.5tr",
    image:
      "https://images.unsplash.com/photo-1555854877-bab0e564b8d5?auto=format&fit=crop&w=400&q=80", // High quality bunk bed dorm image
  },
  {
    id: "fpt-sim-03",
    title: "Phòng trọ gác lửng Hòa Hải (Mezzanine)",
    price: 2200000,
    area: 20,
    location: "Hòa Hải, Ngũ Hành Sơn",
    school: "800m từ ĐHFPT",
    badge: "Xác minh",
    tags: ["Có gác lửng", "Nhà xe rộng"],
    priceRange: "1.5tr - 2.5tr",
    image: roomCard2, // Mezzanine room illustration from artifacts
  },
  {
    id: "fpt-sim-04",
    title: "Phòng trọ Điện Ngọc gác lửng rộng rãi",
    price: 1800000,
    area: 22,
    location: "Điện Ngọc",
    school: "1.2km từ ĐHFPT",
    badge: "Xác minh",
    tags: ["Tự do giờ giấc", "Mặt tiền"],
    priceRange: "1.5tr - 2.5tr",
    image:
      "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&w=400&q=80", // Mezzanine room style image
  },
  {
    id: "fpt-sim-05",
    title: "Căn hộ Studio FPT City Full Nội Thất",
    price: 3500000,
    area: 25,
    location: "FPT City, Ngũ Hành Sơn",
    school: "500m từ ĐHFPT",
    badge: "Xác minh",
    tags: ["Đầy đủ nội thất", "Bếp riêng"],
    priceRange: "2.5tr - 4tr",
    image: roomCard3, // Studio illustration from artifacts
  },
  {
    id: "fpt-sim-06",
    title: "Mini Studio Smart Home thông minh",
    price: 2800000,
    area: 30,
    location: "FPT City, Ngũ Hành Sơn",
    school: "200m từ ĐHFPT",
    badge: "Xác minh",
    tags: ["Nội thất thông minh", "Ban công"],
    priceRange: "2.5tr - 4tr",
    image:
      "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=400&q=80", // Cozy modern studio style
  },
  {
    id: "fpt-sim-07",
    title: "Căn hộ cao cấp View sông Hàn Luxury",
    price: 4500000,
    area: 35,
    location: "Ngũ Hành Sơn, Đà Nẵng",
    school: "1.8km từ ĐHFPT",
    badge: "Xác minh",
    tags: ["Hồ bơi", "Thang máy", "Gym"],
    priceRange: "Trên 4tr",
    image: roomCard4, // Luxury apartment illustration from artifacts
  },
  {
    id: "chotot-132817965",
    title: "👉👉 : CẦN TIỀN BÁN GẤP :   NHÀ KIỆT THÁI THỊ BÔI  2TANG RẤT ĐẸP",
    ...
    school: "Cách FPT 1.8km",
    badge: "Xác minh",
    tags: ["Phòng sạch đẹp", "Rộng rãi", "Điều hòa"],
    priceRange: "3tr - 4tr",
    image: "/crawled_images/chotot-132817965_0.jpg",
    images: [
      "/crawled_images/chotot-132817965_0.jpg",
      "/crawled_images/chotot-132817965_1.jpg",
      "/crawled_images/chotot-132817965_2.jpg",
      "/crawled_images/chotot-132817965_3.jpg",
      "/crawled_images/chotot-132817965_4.jpg",
      "/crawled_images/chotot-132817965_5.jpg",
    ],
  },
  {
    id: "chotot-131438492",
    ...
    school: "Cách FPT 400m",
    badge: "Xác minh",
    tags: ["Phòng sạch đẹp", "Rộng rãi", "Giá rẻ"],
    priceRange: "2tr - 2.5tr",
    image: "/crawled_images/chotot-131438492_0.jpg",
    images: [
      "/crawled_images/chotot-131438492_0.jpg",
      "/crawled_images/chotot-131438492_1.jpg",
      "/crawled_images/chotot-131438492_2.jpg",
      "/crawled_images/chotot-131438492_3.jpg",
      "/crawled_images/chotot-131438492_4.jpg",
      "/crawled_images/chotot-131438492_5.jpg",
    ],
  },
  {
    id: "chotot-132815165",
    ...
    school: "Cách FPT 200m",
    badge: "Xác minh",
    tags: ["Phòng sạch đẹp", "Rộng rãi", "Giá rẻ"],
    priceRange: "1.5tr - 2tr",
    image: "/crawled_images/chotot-132815165_0.jpg",
    images: [
      "/crawled_images/chotot-132815165_0.jpg",
      "/crawled_images/chotot-132815165_1.jpg",
      "/crawled_images/chotot-132815165_2.jpg",
      "/crawled_images/chotot-132815165_3.jpg",
      "/crawled_images/chotot-132815165_4.jpg",
      "/crawled_images/chotot-132815165_5.jpg",
    ],
  },
  {
    id: "chotot-132751803",
    ...
    image: "/crawled_images/chotot-132751803_0.jpg",
    images: [
      "/crawled_images/chotot-132751803_0.jpg",
      "/crawled_images/chotot-132751803_1.jpg",
      "/crawled_images/chotot-132751803_2.jpg",
      "/crawled_images/chotot-132751803_3.jpg",
      "/crawled_images/chotot-132751803_4.jpg",
      "/crawled_images/chotot-132751803_5.jpg",
    ],
  },
  {
    id: "chotot-129346019",
    ...
    area: 100,
    location: "Quận Cẩm Lệ, Đà Nẵng",
    school: "Cách FPT 500m",
    badge: "Xác minh",
    tags: ["Phòng sạch đẹp", "Rộng rãi", "Điều hòa"],
    priceRange: "3tr - 4tr",
    image: "/crawled_images/chotot-129346019_0.jpg",
    images: [
      "/crawled_images/chotot-129346019_0.jpg",
      "/crawled_images/chotot-129346019_1.jpg",
      "/crawled_images/chotot-129346019_2.jpg",
      "/crawled_images/chotot-129346019_3.jpg",
      "/crawled_images/chotot-129346019_4.jpg",
      "/crawled_images/chotot-129346019_5.jpg",
    ],
  },
  {
    id: "chotot-132855036",
    ...
    school: "Cách FPT 800m",
    badge: "Xác minh",
    tags: ["Phòng sạch đẹp", "Rộng rãi", "Giá rẻ"],
    priceRange: "1.5tr - 2tr",
    image: "/crawled_images/chotot-132855036_0.jpg",
    images: [
      "/crawled_images/chotot-132855036_0.jpg",
      "/crawled_images/chotot-132855036_1.jpg",
      "/crawled_images/chotot-132855036_2.jpg",
      "/crawled_images/chotot-132855036_3.jpg",
    ],
  },
  {
    id: "chotot-132815881",
    title: "Cho thuê nhà mặt tiền 2 tầng",
    price: 9000000,
    area: 20,
    location: "Quận Hải Châu, Đà Nẵng",
    school: "Cách FPT 800m",
    badge: "Xác minh",
    tags: ["Phòng sạch đẹp", "Điều hòa"],
    priceRange: "Trên 4tr",
    image: "/crawled_images/chotot-132815881_0.jpg",
    images: [
      "/crawled_images/chotot-132815881_0.jpg",
      "/crawled_images/chotot-132815881_1.jpg",
      "/crawled_images/chotot-132815881_2.jpg",
    ],
  },
  {
    id: "chotot-132854974",
    ...
    area: 130,
    location: "Quận Thanh Khê, Đà Nẵng",
    school: "Cách FPT 600m",
    badge: "Xác minh",
    tags: ["Phòng sạch đẹp", "Rộng rãi", "Giá rẻ"],
    priceRange: "Dưới 1.5tr",
    image: "/crawled_images/chotot-132854974_0.jpg",
    images: [
      "/crawled_images/chotot-132854974_0.jpg",
      "/crawled_images/chotot-132854974_1.jpg",
      "/crawled_images/chotot-132854974_2.jpg",
    ],
  },
  {
    id: "chotot-132854933",
    title: "Chính chủ bán căn villa hiện đại đường Phan Bá Vành sát Sông Hàn",
    price: 2200000,
    area: 150,
    location: "Quận Sơn Trà, Đà Nẵng",
    school: "Cách FPT 1.8km",
    ...
    tags: ["Phòng sạch đẹp", "Rộng rãi", "Giá rẻ"],
    priceRange: "2tr - 2.5tr",
    image: "/crawled_images/chotot-132854933_0.jpg",
    images: [
      "/crawled_images/chotot-132854933_0.jpg",
      "/crawled_images/chotot-132854933_1.jpg",
      "/crawled_images/chotot-132854933_2.jpg",
      "/crawled_images/chotot-132854933_3.jpg",
      "/crawled_images/chotot-132854933_4.jpg",
      "/crawled_images/chotot-132854933_5.jpg",
    ],
  },
  {
    id: "chotot-132759488",
    title: "NHÀ GÓC 2 MẶT TIỀN CÔ BẮC – MẠC ĐĨNH CHI - TRUNG TÂM TP. ĐÀ NẴNG ",
    price: 1200000,
    area: 87,
    location: "Quận Hải Châu, Đà Nẵng",
    school: "Cách FPT 1.2km",
    badge: "Xác minh",
    tags: ["Phòng sạch đẹp", "Rộng rãi", "Giá rẻ"],
    priceRange: "Dưới 1.5tr",
    image: "/crawled_images/chotot-132759488_0.jpg",
    images: [
      "/crawled_images/chotot-132759488_0.jpg",
      "/crawled_images/chotot-132759488_1.jpg",
      "/crawled_images/chotot-132759488_2.jpg",
      "/crawled_images/chotot-132759488_3.jpg",
      "/crawled_images/chotot-132759488_4.jpg",
      "/crawled_images/chotot-132759488_5.jpg",
    ],
  },
  {
    id: "chotot-132830759",
    ...
    badge: "Xác minh",
    tags: ["Phòng sạch đẹp", "Rộng rãi", "Giá rẻ"],
    priceRange: "2.5tr - 3tr",
    image: "/crawled_images/chotot-132830759_0.jpg",
    images: [
      "/crawled_images/chotot-132830759_0.jpg",
      "/crawled_images/chotot-132830759_1.jpg",
      "/crawled_images/chotot-132830759_2.jpg",
    ],
  },
  {
    id: "chotot-132854851",
    title:
      "[CHÍNH CHỦ] Bán nhà 2,5 tầng đường Nguyễn Huy Lượng, P. Nại Hiên Đông",
    price: 5850000,
    area: 55,
    location: "Quận Sơn Trà, Đà Nẵng",
    school: "Cách FPT 1.8km",
    ...
    tags: ["Phòng sạch đẹp", "Rộng rãi", "Điều hòa"],
    priceRange: "Trên 4tr",
    image: "/crawled_images/chotot-132854851_0.jpg",
    images: [
      "/crawled_images/chotot-132854851_0.jpg",
      "/crawled_images/chotot-132854851_1.jpg",
      "/crawled_images/chotot-132854851_2.jpg",
      "/crawled_images/chotot-132854851_3.jpg",
    ],
  },
  {
    id: "chotot-111727546",
    title: "Bán BIỆT THỰ 2 mặt tiền đường 10m5, hướng đông nam mới đẹp",
    price: 2500000,
    area: 165,
    location: "Quận Cẩm Lệ, Đà Nẵng",
    school: "Cách FPT 200m",
    ...
    tags: ["Phòng sạch đẹp", "Rộng rãi", "Giá rẻ"],
    priceRange: "2tr - 2.5tr",
    image: "/crawled_images/chotot-111727546_0.jpg",
    images: [
      "/crawled_images/chotot-111727546_0.jpg",
      "/crawled_images/chotot-111727546_1.jpg",
      "/crawled_images/chotot-111727546_2.jpg",
      "/crawled_images/chotot-111727546_3.jpg",
      "/crawled_images/chotot-111727546_4.jpg",
      "/crawled_images/chotot-111727546_5.jpg",
    ],
  },
  {
    id: "chotot-132854756",
    ...
    image: "/crawled_images/chotot-132854756_0.jpg",
    images: [
      "/crawled_images/chotot-132854756_0.jpg",
      "/crawled_images/chotot-132854756_1.jpg",
      "/crawled_images/chotot-132854756_2.jpg",
      "/crawled_images/chotot-132854756_3.jpg",
      "/crawled_images/chotot-132854756_4.jpg",
      "/crawled_images/chotot-132854756_5.jpg",
    ],
  },
  {
    id: "chotot-132153142",
    title: "🚨 Chỉ 3.85 tỷ – Nhà Lê Trọng Tấn, kiệt 3m – giá hiếm trong khu",
    price: 3850000,
    area: 75,
    location: "Quận Cẩm Lệ, Đà Nẵng",
    school: "Cách FPT 1.2km",
    ...
    tags: ["Phòng sạch đẹp", "Rộng rãi", "Điều hòa"],
    priceRange: "3tr - 4tr",
    image: "/crawled_images/chotot-132153142_0.jpg",
    images: [
      "/crawled_images/chotot-132153142_0.jpg",
      "/crawled_images/chotot-132153142_1.jpg",
      "/crawled_images/chotot-132153142_2.jpg",
      "/crawled_images/chotot-132153142_3.jpg",
      "/crawled_images/chotot-132153142_4.jpg",
      "/crawled_images/chotot-132153142_5.jpg",
    ],
  },
];
...
function SearchPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (q.toLowerCase().includes("fpt")) {
        ...
        q.toLowerCase().includes("bách khoa") ||
        q.toLowerCase().includes("bk")
      ) {
        setSelectedUni("bachKhoa");
      } else if (
        q.toLowerCase().includes("sư phạm") ||
        q.toLowerCase().includes("sp")
      ) {
        setSelectedUni("supham");
      } else if (
        q.toLowerCase().includes("duy tân") ||
        q.toLowerCase().includes("dt")
      ) {
  ...
  const handleToggleSave = (id: string) => {
    ...
    showToast(
      savedRooms.includes(id)
        ? "Đã bỏ lưu phòng!"
        : "Đã lưu phòng thành công! Bookmark",
    );
  };
  ...
  const filteredRealRooms = useMemo(() => {
    ...
    return baseRooms.filter((r) => {
      ...
      if (selectedPriceRange === "1.5tr - 2tr")
        return r.price >= 1500000 && r.price <= 2000000;
      if (selectedPriceRange === "2tr - 2.5tr")
        return r.price > 2000000 && r.price <= 2500000;
      if (selectedPriceRange === "2.5tr - 3tr")
        return r.price > 2500000 && r.price <= 3000000;
      if (selectedPriceRange === "3tr - 4tr")
        return r.price > 3000000 && r.price <= 4000000;
  ...
  const filteredSimulatorRooms = useMemo(() => {
    return fptPriceSimulatorRooms.filter(
      (r) => r.priceRange === selectedPriceRange,
    );
  }, [selectedPriceRange]);
      ...
      {!showFptPriceFilter ? (
        <main className="flex-1 max-w-7xl w-full mx-auto px-4 py-8 space-y-10">
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-xs text-slate-500 max-w-xl mx-auto leading-relaxed">
              Nhanh chóng, tiện lợi và an tâm. Chọn trường đại học của bạn để
              xem danh sách phòng trọ tốt nhất được chúng tôi xác minh.
            </p>
          </div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    if (e.target.value === "Liên Chiểu") {
                      setSelectedUni(
                        selectedUni === "supham" ? "supham" : "bachKhoa",
                      );
            ...
            <section className="grid gap-6 lg:grid-cols-12 items-stretch text-left">
              ...
              <div className="lg:col-span-8 bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-sm flex flex-col sm:flex-row items-stretch">
                <div className="sm:w-7/12 p-8 md:p-10 flex flex-col justify-between space-y-6 text-left">
                  <div className="space-y-4">
                    ...
                    <p className="text-xs text-slate-500 leading-relaxed max-w-md">
                      Hệ thống hỗ trợ sinh viên tìm phòng nhanh, giá tốt và đảm
                      bảo an toàn tuyệt đối với các phòng đã xác minh thực tế.
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-2.5 pt-2">
                    ...
                    <span
                      className="flex items-center gap-1 text-slate-850 bg-brand-yellow px-3.5 py-1.5 rounded-full font-extrabold text-[10px] shadow-sm"
                ...
                <div className="sm:w-5/12 bg-slate-100 relative min-h-[200px] overflow-hidden group">
                  <img
                    src={uniConfigs[selectedUni].image}
              ...
              <div className="lg:col-span-4 flex flex-col gap-6 justify-between text-left">
                {/* Stats */}
                <div
                  className="bg-brand-yellow p-6 rounded-3xl flex-1 flex flex-col justify-between text-slate-850 hover-raise"
                  style={{ backgroundColor: "var(--brand-yellow)" }}
                >
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <div className="text-4xl font-extrabold tracking-tight">
                        {mockDatabase[selectedUni]?.length || 0}
                      </div>
                    ...
                    <div>
                      <div className="text-4xl font-extrabold tracking-tight">
                        {uniConfigs[selectedUni].verifiedRate}
                      </div>
                      <div className="text-[10px] font-bold uppercase tracking-wider text-slate-600 mt-1">
                        Đã xác minh
                      </div>
                  ...
                  <div className="pt-4 mt-4 border-t border-slate-900/10 flex justify-between items-end">
                    <div>
                      <div className="text-2xl font-extrabold tracking-tight text-slate-800">
                        {uniConfigs[selectedUni].avgPrice}
                      </div>
                      <div className="text-[10px] font-bold uppercase tracking-wider text-slate-600 mt-1">
                ...
                <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm space-y-3">
                  ...
                  <div className="space-y-2.5">
                    {[
                      {
                        title: "Khu vực gần cổng trường",
                        desc: "Tiện lợi đi lại học tập",
                        img: "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&w=120&q=80",
                      },
                      {
                        title: "Trục đường chính lân cận",
                        desc: "Sầm uất, nhiều tiện ích sinh viên",
                        img: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=120&q=80",
                      },
                    ].map((item, idx) => (
                      <div
                        key={idx}
                        className="flex items-center gap-3 p-1.5 rounded-xl hover:bg-slate-50 border border-transparent hover:border-slate-100 transition-colors cursor-pointer group"
                      >
                        ...
                        <div className="ml-2">
                          <h4 className="text-[11px] font-bold text-slate-800 group-hover:text-[#8B5A2B] transition-colors">
                            {item.title}
                          </h4>
            ...
            <section className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-extrabold text-slate-800 tracking-tight">
                    Phòng mới quanh {uniConfigs[selectedUni].name}
                  </h2>
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                {paginatedRooms.map((room) => (
                  <div
                    key={room.id}
                    className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden hover-raise group flex flex-col justify-between"
                  >
                    {/* Image Frame */}
                    <div className="relative aspect-[4/3] w-full overflow-hidden image-zoom-container">
                      ...
                      {/* Status badges */}
                      <span
                        className="absolute top-3 left-3 px-2.5 py-0.5 rounded bg-green-50 text-green-700 border border-green-200 text-[9px] font-extrabold uppercase tracking-wider"
                        style={{
                      ...
                      {room.specialBadge && (
                        <span
                          className="absolute top-3 right-3 px-2.5 py-0.5 rounded bg-amber-50 text-brand-brown text-[9px] font-extrabold uppercase tracking-wider"
                          style={{ backgroundColor: "var(--brand-yellow)" }}
                        >
                          {room.specialBadge}
                        </span>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {room.tags.map((tag) => (
                            <span
                              key={tag}
                              className="text-[9px] font-bold text-slate-500 bg-slate-50 px-2 py-0.5 rounded-full border border-slate-150"
                            >
                              {tag}
                            </span>
                          ))}
            ...
            <section className="grid gap-6 md:grid-cols-12 items-stretch">
              ...
              <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm md:col-span-6 space-y-4">
                <h3 className="font-bold text-slate-800 text-sm flex items-center gap-1">
                  🛣️ Tìm theo tuyến đường quanh{" "}
                  {uniConfigs[selectedUni].shortName}
                </h3>
                <div className="flex flex-wrap gap-2">
                  {uniConfigs[selectedUni].streets.map((st) => (
                    <button
                      key={st}
                      onClick={() =>
                        showToast(`Lọc phòng trên tuyến đường ${st}`)
                      }
              ...
              <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm md:col-span-6 flex flex-col justify-between min-h-[180px]">
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 mt-1">
                    Xem tất cả phòng trọ trên bản đồ quanh khu vực bạn chọn.
                  </p>
                </div>
                ...
                <button
                  onClick={() =>
                    showToast(
                      `Mở bản đồ lớn khu ${uniConfigs[selectedUni].name}...`,
                    )
                  }
        ...
        <main className="flex-1 max-w-7xl w-full mx-auto px-4 py-6 md:py-8 space-y-6 animate-fade-in">
          ...
          <div className="text-[11px] font-semibold text-slate-400 flex items-center gap-1">
            ...
            >
              Gần {uniConfigs[selectedUni].name}
            </button>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-500 max-w-2xl leading-relaxed">
              Tìm kiếm các phòng trọ, căn hộ dịch vụ khu vực FPT City, Hòa Hải,
              Điện Ngọc và lân cận cho sinh viên. Môi trường an ninh, giá cả phù
              hợp từ 2tr - 4tr.
            </p>
          </div>
          ...
          <section className="bg-white p-3 rounded-2xl shadow-sm border border-slate-100 flex flex-wrap items-center gap-2 justify-between">
            <div className="flex flex-wrap items-center gap-2">
              <button
                className="h-9 px-3 rounded-xl bg-brand-yellow font-bold text-slate-800 text-xs flex items-center gap-1"
                style={{ backgroundColor: "var(--brand-yellow)" }}
              >
              ...
              <button className="h-9 px-3.5 rounded-xl bg-slate-50 hover:bg-slate-100 text-slate-500 text-xs font-bold">
                Diện tích
              </button>
              <button
                className="h-9 px-3.5 rounded-xl bg-brand-green-bg text-brand-green-text text-xs font-bold flex items-center gap-1 border border-transparent"
                style={{
                  backgroundColor: "var(--brand-green-bg)",
                  color: "var(--brand-green-text)",
                }}
          ...
          <div className="grid gap-3 grid-cols-2 sm:grid-cols-4">
            {[
              ...
              },
              {
                ...
                status: "Phố Trọ",
                dist: "Trục chính",
                bg: "bg-blue-50/40 border-blue-100/40",
              },
              {
                title: "Ký túc xá",
                status: "Tiết kiệm",
            ...
            <div className="lg:col-span-8 space-y-6">
              <div className="text-xs font-bold text-slate-400 mb-2">
                ...
                <span className="text-slate-800">
                  {filteredRealRooms.length}
                </span>{" "}
                phòng trọ phù hợp mức giá{" "}
                ...
                {paginatedFilteredRealRooms.map((room) => (
                  ...
                  >
                    ...
                    <div className="relative aspect-[16/11] w-full overflow-hidden image-zoom-container">
                      ...
                      <span
                        className="absolute top-3 left-3 px-2.5 py-0.5 rounded bg-brand-green-bg text-brand-green-text text-[9px] font-extrabold uppercase tracking-wider"
                        style={{
                          backgroundColor: "var(--brand-green-bg)",
                          color: "var(--brand-green-text)",
                        }}
                      ...
                      >
                        <Heart
                          className={`h-4.5 w-4.5 ${savedRooms.includes(room.id) ? "fill-red-500 text-red-500" : ""}`}
                        />
                      </button>
                    </div>
              ...
              {Math.ceil(filteredRealRooms.length / detailRoomsPerPage) > 1 && (
                <div className="flex items-center justify-center gap-2 pt-4 border-t border-slate-100">
                  ...
                  {Array.from({
                    length: Math.ceil(
                      filteredRealRooms.length / detailRoomsPerPage,
                    ),
                  }).map((_, idx) => (
                    <button
                      key={idx}
                  ...
                  <button
                    disabled={
                      currentDetailPage ===
                      Math.ceil(filteredRealRooms.length / detailRoomsPerPage)
                    }
                    onClick={() =>
                      setCurrentDetailPage((p) =>
                        Math.min(
                          Math.ceil(
                            filteredRealRooms.length / detailRoomsPerPage,
                          ),
            ...
            <aside className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm space-y-3">
                <div className="flex items-center justify-between text-slate-800 text-xs font-bold border-b border-slate-50 pb-2">
                  <span className="flex items-center gap-1">
                    <Map className="h-4 w-4 text-slate-400" /> Xem trên bản đồ
                  </span>
                  <button
                    onClick={() => showToast("Bản đồ lớn...")}
                ...
                {/* Map simulator FPT */}
                <div
                  className="h-60 rounded-2xl relative overflow-hidden flex items-center justify-center border border-slate-100 shadow-inner bg-cover bg-center"
                  style={{ backgroundImage: `url(${mapBg})` }}
                >
                  <div className="absolute inset-0 bg-slate-900/10" />
                  <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-10">
                    <div
                      className="h-8 w-8 bg-brand-yellow rounded-full flex items-center justify-center border-4 border-white shadow-md text-xs animate-pulse"
                      style={{ backgroundColor: "var(--brand-yellow)" }}
                    >
                      📍
                    </div>
                    <span className="bg-slate-800 text-white text-[8px] font-bold px-2 py-0.5 rounded-full mt-1">
                      {uniConfigs[selectedUni].name}
                    </span>
                  </div>
                </div>
                ...
                <div className="text-[10px] text-slate-500 text-center leading-relaxed">
                  ...
                  phòng đang sẵn sàng trong bán kính 1km quanh{" "}
                  {uniConfigs[selectedUni].name}.
                </div>
              </div>
              ...
              <div className="bg-[#112419] p-6 rounded-3xl text-white shadow-md space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-extrabold text-sm text-[#ffc72c]">
                    Hỗ trợ tìm phòng cho Tân sinh viên
                  </h4>
                </div>
                <p className="text-[10px] text-white/80 leading-relaxed">
                  Bạn chưa tìm được phòng ưng ý? Đội ngũ Sâu tìm trọ sẽ hỗ trợ
                  bạn tìm phòng theo yêu cầu hoàn toàn miễn phí.
                </p>
                <button
              ...
              <div className="bg-[#f8fafc] border border-slate-200/50 p-4 rounded-2xl flex gap-3 text-slate-500 text-[10px] leading-relaxed">
                ...
                <div>
                  ...
                  <span>
                    Mọi thông tin phòng đã được kiểm duyệt thực tế 100%.
                  </span>
                </div>
              </div>
            </aside>
