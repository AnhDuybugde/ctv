  ...
  head: () => ({
    meta: [
      { title: "Đăng nhập & Xác thực — Sâu tìm trọ" },
      {
        name: "description",
        content:
          "Đăng nhập và xác thực tài khoản sinh viên hoặc chủ trọ của bạn.",
      },
    ],
  }),
...
function OnboardingPage() {
  ...
  const handleLoginSubmit = (e: React.FormEvent) => {
    ...
    if (!email) {
      setEmail(
        role === "student"
          ? "hoangphu.student@fpt.edu.vn"
          : "le.anh.dung@email.com",
      );
    }
    setStep(3);
  };
  ...
  return (
    ...
    >
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-12 md:py-16">
        {/* Progress Stepper */}
        <div className="w-full max-w-4xl mb-12">{renderStepHeader()}</div>
              ...
              <div className="grid gap-6 md:grid-cols-2 w-full max-w-3xl">
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-slate-800 mb-3">
                    Sinh viên / Người thuê phòng
                  </h3>
                  <p className="text-slate-500 text-sm mb-8 leading-relaxed max-w-xs flex-1">
                    Tìm phòng gần trường, lưu phòng yêu thích, xem bản đồ và
                    liên hệ phòng phù hợp.
                  </p>
                  <button
                    onClick={() => handleRoleSelect("student")}
                ...
                >
                  ...
                  <p className="text-slate-500 text-sm mb-8 leading-relaxed max-w-xs flex-1">
                    Đăng tin phòng trọ, quản lý bài đăng và tiếp cận sinh viên
                    đang tìm phòng.
                  </p>
                  <button
                    onClick={() => handleRoleSelect("landlord")}
              ...
              <div className="w-full md:w-5/12 bg-slate-50 border-r border-slate-100 p-8 flex flex-col justify-between">
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <h3 className="text-2xl font-extrabold text-slate-800">
                      Tạo tài khoản{" "}
                      {role === "student" ? "sinh viên" : "chủ trọ"}
                    </h3>
                ...
                <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4">
                  ...
                  <div className="text-xs">
                    ...
                    <span className="block mt-1 font-bold text-[#ffc700]">
                      — Sâu Nhỏ
                    </span>
                  </div>
                </div>
                ...
                <div className="max-w-md w-full mx-auto">
                  ...
                  <form onSubmit={handleLoginSubmit} className="space-y-5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative flex items-center bg-slate-50 border border-slate-200 rounded-xl overflow-hidden focus-within:border-amber-300 focus-within:ring-1 focus-within:ring-amber-100 transition-all">
                    ...
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between">
                        ...
                        <a
                          href="#forgot"
                          className="text-xs text-[#ffc700] font-bold hover:underline"
                        >
                          Quên mật khẩu?
                        </a>
                      </div>
                    ...
                    <label className="flex items-center gap-2 cursor-pointer pt-1">
                      <input
                        type="checkbox"
                        className="rounded text-amber-500 focus:ring-amber-300 focus:ring-opacity-25 h-4 w-4"
                      />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      onClick={() => setStep(3)}
                      className="flex items-center justify-center gap-2 py-3 px-4 border border-slate-200 rounded-xl text-slate-700 font-bold text-xs hover:bg-slate-50 transition-colors"
                    >
                      <svg className="h-4 w-4 shrink-0" viewBox="0 0 24 24">
                        <path
                          fill="#EA4335"
                          d="M12.24 10.285V14.4h6.887c-.648 2.41-2.519 4.114-5.187 4.114-3.486 0-6.314-2.828-6.314-6.314s2.828-6.314 6.314-6.314c1.558 0 2.977.57 4.075 1.5l3.056-3.056C19.227 2.686 15.918 1 12.24 1 5.65 1 .3 6.35.3 12.9s5.35 11.9 11.94 11.9c6.26 0 11.5-4.47 11.5-11.9 0-.756-.07-1.488-.2-2.19l-11.3 2.19z"
                        />
                      </svg>
                      Google
                    </button>
              ...
              <div className="w-full md:w-5/12 bg-slate-50 border-r border-slate-100 p-8 flex flex-col justify-between">
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-slate-500">
                      Chúng tôi cam kết bảo mật mọi thông tin và chỉ xác minh
                      danh tính thực để đảm bảo an toàn cho cộng đồng trọ.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4">
                  ...
                  <div className="text-xs">
                    <p className="text-slate-700 italic font-medium leading-relaxed">
                      "Chào bạn nhé! Xác thực giúp tin đăng của bạn uy tín hơn
                      và nhận được badge 'Sinh viên uy tín' nữa đó."
                    </p>
                    <span className="block mt-1 font-bold text-[#ffc700]">
                      — Sâu Nhỏ
                    </span>
                ...
                <div className="max-w-md w-full mx-auto space-y-6">
                  ...
                  <div className="space-y-3">
                    <h4 className="text-xs font-bold text-slate-500 uppercase tracking-widest">
                      Phương pháp 1: Qua Email sinh viên
                    </h4>
                    <div className="flex gap-2">
                      <div className="relative flex-1 flex items-center bg-slate-50 border border-slate-200 rounded-xl overflow-hidden">
                        <Mail className="h-4 w-4 ml-4 text-slate-400" />
                        <input
                          type="email"
                          placeholder="email@student.edu.vn"
                          defaultValue={email || "hoangphu.student@fpt.edu.vn"}
                          className="w-full px-3 py-3 text-sm bg-transparent outline-none text-slate-800"
                        />
                      </div>
                      <button
                        type="button"
                  ...
                  <div className="space-y-3">
                    <h4 className="text-xs font-bold text-slate-500 uppercase tracking-widest">
                      Phương pháp 2: Tải thẻ sinh viên
                    </h4>
                    <div className="grid grid-cols-2 gap-4">
                      {/* Front Card */}
                      <button
                      ...
                      >
                        <Upload
                          className={`h-6 w-6 ${frontCardUploaded ? "text-green-500" : "text-slate-400"}`}
                        />
                      ...
                      >
                        <Upload
                          className={`h-6 w-6 ${backCardUploaded ? "text-green-500" : "text-slate-400"}`}
                        />
                        <span className="text-[11px] font-bold text-slate-700">
                          Mặt sau thẻ
                        </span>
                    ...
                    <p className="text-[10px] text-slate-400 italic">
                      * Hình ảnh cần rõ nét, không bị lóa hoặc che mất thông tin
                      quan trọng.
                    </p>
                  </div>
                  ...
                  <div className="pt-4 flex flex-col gap-3">
                    ...
                    <button
                      type="button"
                      onClick={() => setStep(2)}
                      className="w-full py-2.5 px-6 rounded-xl font-bold text-slate-500 hover:text-slate-800 text-xs transition-all text-center"
                    >
                      Quay lại
                    </button>
                  </div>
              ...
              <div className="w-full md:w-5/12 bg-slate-50 border-r border-slate-100 p-8 flex flex-col justify-between">
                <div className="space-y-6">
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-slate-500">
                      Thông tin của bạn đang được Sâu Tìm Trọ kiểm tra để đảm
                      bảo chất lượng và độ tin cậy của tin đăng.
                    </p>
                  </div>
                  ...
                  <div className="bg-blue-50 border border-blue-100 p-4 rounded-2xl flex gap-3 text-blue-700 text-xs leading-relaxed">
                    ...
                    <div>
                      ...
                      <p className="text-blue-600 mt-0.5">
                        Thường từ 24 - 48 giờ. Bạn sẽ nhận được thông báo khi
                ...
                <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4">
                  ...
                  <div className="text-xs">
                    <p className="text-slate-700 italic font-medium leading-relaxed">
                      "Chờ một xíu thời nhé, tớ đang kiểm tra hồ sơ của bạn cực
                      kỳ kỹ lưỡng đây!"
                    </p>
                    <span className="block mt-1 font-bold text-[#ffc700]">
                      — Sâu Tìm Trọ
                ...
                <div className="max-w-md w-full mx-auto text-center space-y-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-slate-500 leading-relaxed max-w-sm mx-auto">
                      Trong thời gian chờ duyệt, bạn có thể xem lại thông tin
                      tài khoản hoặc quay về trang chủ để khám phá các tiện ích
                      khác của Sâu Tìm Trọ.
                    </p>
                  </div>
                  ...
                  <div className="bg-slate-50 border border-slate-100 rounded-2xl p-5 text-left text-xs space-y-3.5 max-w-sm mx-auto shadow-inner">
                    <h5 className="font-bold text-slate-700 border-b border-slate-200/60 pb-1.5 uppercase tracking-wider text-[10px]">
                      Tóm tắt hồ sơ
                    </h5>
                    <div className="grid grid-cols-2 gap-y-2.5">
                      ...
                      <div>
                        ...
                        <span className="text-slate-800 font-bold truncate block max-w-[150px]">
                          {email || "hoangphu.student@fpt.edu.vn"}
                        </span>
                      </div>
                      <div>
                        <span className="text-slate-400 font-medium block">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2 max-w-sm mx-auto">
                    <button
                      ...
                      className="flex-1 py-3 px-5 rounded-xl font-bold text-slate-800 hover:opacity-95 transition-all flex items-center justify-center gap-1.5 shadow-sm text-xs"
                      style={{ backgroundColor: "var(--brand-yellow)" }}
                    >
                    ...
                    <button
                      onClick={handleGoHome}
                      className="flex-1 py-3 px-5 rounded-xl border border-slate-200 bg-white text-slate-600 font-bold hover:bg-slate-50 transition-all flex items-center justify-center gap-1.5 shadow-sm text-xs"
                    >
