...
export function SiteFooter() {
  return (
    ...
    <footer className="mt-0" style={{ backgroundColor: "var(--cocoa-deep)" }}>
      {/* Main footer grid */}
      <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-10 py-12 md:py-16">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            ...
            >
              Sâu nhỏ giúp bạn tìm tổ ấm đáng yêu giữa lòng Đà Nẵng — nhanh, dễ
              và ngọt như mật ong.
            </p>
      ...
      >
        ...
        >
          <span>
            © {new Date().getFullYear()} Sâu tìm trọ — Made with ♥ in Đà Nẵng
          </span>
