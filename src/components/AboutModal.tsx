      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-cocoa/5 bg-white">
          <div className="flex items-center gap-2">
            <span
              className="h-3 w-3 rounded-full bg-brand-yellow"
              style={{ backgroundColor: "#ffc72c" }}
            />
            <span className="text-sm font-bold text-cocoa/60 uppercase tracking-wider">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-8 md:px-12 md:py-12 space-y-20 bg-gradient-to-b from-[#f8f9fa] to-white scrollbar-thin">
          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
            <div className="lg:col-span-7 space-y-6">
              <h1 className="text-4xl md:text-5xl font-extrabold text-cocoa leading-[1.1] tracking-tight">
                Vì sao sinh viên chọn{" "}
                <span style={{ color: "#8B5A2B" }}>Sâu Tìm Trọ</span>?
              </h1>
              <p className="text-lg text-cocoa/80 leading-relaxed max-w-xl">
                Nền tảng giúp sinh viên Đà Nẵng tìm phòng gần trường nhanh hơn,
                minh bạch hơn và an tâm hơn với sự hỗ trợ từ đội ngũ xác thực.
              </p>
          ...
          <div className="space-y-10">
            <div className="text-center max-w-2xl mx-auto space-y-2">
              <h2 className="text-3xl font-bold text-cocoa tracking-tight">
                Lợi ích vượt trội cho người đi thuê
              </h2>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="group bg-white p-6 rounded-2xl border border-cocoa/5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <div
                  className="h-12 w-12 rounded-xl bg-brand-yellow/10 flex items-center justify-center mb-5"
                  style={{ backgroundColor: "#fff9e6" }}
                >
                  <GraduationCap className="h-6 w-6 text-[#ffc72c] icon-wiggle-effect" />
                </div>
                <h3 className="text-lg font-bold text-cocoa mb-2">
                  Tìm phòng gần trường
                </h3>
                <p className="text-sm text-cocoa/70 leading-relaxed">
                  Lọc phòng theo từng trường đại học, khu vực và khoảng cách di
                  chuyển chính xác.
                </p>
              </div>
              ...
              <div className="group bg-white p-6 rounded-2xl border border-cocoa/5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <h3 className="text-lg font-bold text-cocoa mb-2">
                  Tin đăng được xác minh
                </h3>
                <p className="text-sm text-cocoa/70 leading-relaxed">
                  Ưu tiên phòng có thông tin rõ ràng, hình ảnh thực tế và quy
                  trình kiểm tra nghiêm ngặt.
                </p>
              </div>
              ...
              <div className="group bg-white p-6 rounded-2xl border border-cocoa/5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-sm text-cocoa/70 leading-relaxed">
                  Hiển thị giá thuê, tiền cọc, chi phí điện nước và tiện ích rõ
                  ràng ngay từ đầu.
                </p>
              </div>
              ...
              <div className="group bg-white p-6 rounded-2xl border border-cocoa/5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 lg:col-start-2 lg:col-span-1">
                ...
                <p className="text-sm text-cocoa/70 leading-relaxed">
                  Dễ dàng kiểm tra khoảng cách từ phòng đến trường, chợ, siêu
                  thị và các tiện ích công cộng.
                </p>
              </div>
              ...
              <div className="group bg-white p-6 rounded-2xl border border-cocoa/5 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-sm text-cocoa/70 leading-relaxed">
                  Giúp phụ huynh kiểm tra thông tin phòng, khu vực, mức giá và
                  độ an toàn trước khi con em mình thuê.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-10">
            ...
            <div className="grid gap-8 md:grid-cols-3 relative">
              ...
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <p className="text-sm text-cocoa/70 max-w-xs">
                  Tinh chỉnh kết quả theo nhu cầu tài chính và khu vực yêu
                  thích.
                </p>
              </div>
          ...
          <div className="space-y-10">
            ...
            <div className="grid gap-6 md:grid-cols-2 max-w-4xl mx-auto">
              ...
              <div className="bg-white p-8 rounded-3xl border border-cocoa/5 shadow-sm space-y-6">
                <h3 className="text-xl font-bold text-cocoa/50">
                  Tìm trọ truyền thống
                </h3>
                <ul className="space-y-4">
                  {[
                    ...
                    <li
                      key={idx}
                      className="flex items-start gap-3 text-sm text-cocoa/70"
                    >
                      <span className="h-5 w-5 rounded-full bg-red-100 text-red-600 flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">
                        ✕
                      </span>
                      <span>{item}</span>
                    </li>
              ...
              <div className="bg-[#112419] p-8 rounded-3xl text-white shadow-xl space-y-6 relative overflow-hidden">
                <div
                  className="absolute top-4 right-4 bg-brand-yellow text-cocoa text-[10px] font-extrabold uppercase px-2.5 py-1 rounded-full"
                  style={{ backgroundColor: "#ffc72c" }}
                >
                  Khuyên dùng
                </div>
                <h3 className="text-xl font-bold text-[#ffc72c]">
                  Sâu Tìm Trọ
                </h3>
                <ul className="space-y-4">
                  {[
                    ...
                    >
                      <span className="h-5 w-5 rounded-full bg-[#ffc72c] text-cocoa flex items-center justify-center font-bold text-xs shrink-0 mt-0.5">
                        ✓
                      </span>
                      <span>{item}</span>
                    </li>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center bg-[#f0f4f8] p-8 md:p-12 rounded-[32px] border border-cocoa/5">
            ...
            <div className="relative flex justify-center bg-white p-4 rounded-2xl shadow-md border border-cocoa/5">
              <div className="relative overflow-hidden rounded-xl bg-gray-200 aspect-[4/3] w-full">
                ...
                <div className="absolute inset-0 bg-[#e3eaef] flex items-center justify-center">
                  ...
                  <span className="text-xs font-bold text-cocoa/40">
                    Bản đồ đo lường khoảng cách
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-cocoa leading-tight">
                An tâm tuyệt đối cho Phụ huynh
              </h2>
              <p className="text-sm text-cocoa/80 leading-relaxed">
                Chúng tôi hiểu rằng việc tìm chỗ ở cho con em xa nhà là nỗi lo
                lớn nhất của phụ huynh. Sâu Tìm Trọ không chỉ cung cấp thông tin
                phòng, mà còn đánh giá:
              </p>
              <div className="space-y-3">
                {[
                  ...
                  {
                    icon: ShieldCheck,
                    text: "Xác nhận chính chủ, tránh lừa đảo tiền cọc.",
                  },
                  {
                    icon: Ruler,
                    text: "Đo lường quãng đường đi bộ an toàn tới trường.",
                  },
                ].map((item, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="flex items-center gap-3 bg-white/60 p-3.5 rounded-xl border border-cocoa/5"
                    >
                      <div className="h-8 w-8 rounded-lg bg-brand-yellow/10 flex items-center justify-center text-[#ffc72c]">
                        <Icon className="h-4 w-4" />
                      </div>
                      <span className="text-xs font-bold text-cocoa/80">
                        {item.text}
                      </span>
                    </div>
                  );
          ...
          <div className="grid gap-6 grid-cols-1 sm:grid-cols-3 text-center max-w-4xl mx-auto py-8 border-y border-cocoa/10">
            <div>
              <div className="text-4xl font-extrabold text-[#8B5A2B]">
                200.000+
              </div>
              <div className="text-xs font-bold text-cocoa/50 mt-1 uppercase tracking-wider">
                Lượt tìm kiếm phòng trọ hàng tháng
              </div>
            </div>
            <div>
              <div className="text-4xl font-extrabold text-[#8B5A2B]">
              ...
              <div className="text-xs font-bold text-cocoa/50 mt-1 uppercase tracking-wider">
                Phòng trọ đã được đội ngũ xác thực
              </div>
            </div>
            <div>
          ...
          <div className="bg-gradient-to-r from-[#faf5e8] to-[#fffaee] border border-[#ffc72c]/30 rounded-[32px] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-6 flex-wrap md:flex-nowrap">
              ...
              <div className="space-y-2 text-center md:text-left">
                <h3 className="text-2xl font-bold text-cocoa">
                  Sẵn sàng tìm phòng gần trường chưa?
                </h3>
                <p className="text-sm text-cocoa/70 max-w-md">
                  Gia nhập cộng đồng 20.000+ sinh viên Đà Nẵng đã tìm thấy "tổ
                  ấm" ưng ý qua Sâu Tìm Trọ.
                </p>
              </div>
            </div>
