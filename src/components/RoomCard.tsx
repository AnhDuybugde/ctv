  ...
  return (
    <article
      ...
      style={{
        ...
        boxShadow:
          "0 0 0.5px 0 rgba(0,0,0,0.14), 0 1px 1px 0 rgba(0,0,0,0.24)" /* whisper dual */,
      ...
      <Link to="/room/$id" params={{ id: room.id }} className="block">
        ...
        >
          ...
          >
            <Star
              className="h-3 w-3"
              style={{ color: "var(--honey)", fill: "var(--honey)" }}
            />
            {room.rating}
          </div>
        </div>
      ...
      <div className="p-4">
        ...
        <Link to="/room/$id" params={{ id: room.id }}>
          <h3
            ...
            onMouseEnter={(e) =>
              ((e.target as HTMLElement).style.color = "var(--leaf)")
            }
            onMouseLeave={(e) =>
              ((e.target as HTMLElement).style.color = "var(--cocoa)")
            }
          >
            {room.title}
          </h3>
